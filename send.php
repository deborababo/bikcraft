...
$email_envio = 'bikcraft@general.bikcraft.com'; // E-mail receptor
$email_pass = 'phpFilesNeverShowUpHisContent'; // Senha do e-mail

$site_name = 'bikcraft'; // name do Site
